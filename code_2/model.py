...
# 建立模型
def buildTrainModel(modelIndex, modelParameter):
    ...
    rf3 = XGBRegressor(objective="reg:linear", n_estimators=modelParameter, learning_rate=0.05,
                       max_depth=8, min_child_weight=6, subsample=0.9,
                       colsample_bytree=0.9, silent=1, reg_lambda=0.0, seed=0)
